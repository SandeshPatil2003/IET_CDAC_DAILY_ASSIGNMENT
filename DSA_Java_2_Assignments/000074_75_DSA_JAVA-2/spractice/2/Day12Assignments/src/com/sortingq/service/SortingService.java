...
private int partitionEmp(Employee[] earr2, int low, int high) {
	...
	while(true)
	{
		...
		do {
			...
			i++;
		}while(earr2[i].getSalary()<pivot.getSalary());
		
		
		do {
			
			j--;
		}while(earr2[j].getSalary()>pivot.getSalary());
...
public void displayint(int[] iarr1) {
	
	System.out.println(Arrays.toString(iarr1));
	
}

public void insertionSortInt(int[] iarr1) {
...
public void arrRestSumReplace() {
	
	Scanner sc = new Scanner(System.in);
	
	System.out.println("what size array to you want?");
	...
	{
		 System.out.print("enter for number " +(i+1)); ;
		arr[i]=sc.nextInt();
	}
	...
	System.out.println("Replace Rest Sum array : "+Arrays.toString(narr));
	Arrays.sort(narr);
	System.out.println("Replace Rest Sum array : "+Arrays.toString(narr));
