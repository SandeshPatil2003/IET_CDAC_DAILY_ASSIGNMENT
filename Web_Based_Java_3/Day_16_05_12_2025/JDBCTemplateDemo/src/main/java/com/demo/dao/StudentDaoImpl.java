...
public class StudentDaoImpl implements StudentDao{
	...
	public boolean save(Student s) {
		...
		int n=jdbctemplate.update("insert into students201 values(?,?,?,?)",
				new Object[] {s.getSid(),s.getSname(),s.getRollno(),s.getCourse()});
	...
	public List<Student> showAll() {
		...
		List<Student> slist = jdbctemplate.query("Select * from students201",
