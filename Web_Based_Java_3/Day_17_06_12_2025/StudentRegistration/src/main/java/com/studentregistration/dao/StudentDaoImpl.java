...
public class StudentDaoImpl implements StudentDao{
	...
	public boolean updateStudent(Student s1) {
		...
		int n = jdbctemplate.update("update studentregister101 set sname=? , email=? , username=? where sid=?",
				
									new Object[] {s1.getSname(),s1.getEmail(),s1.getUsername(),s1.getSid()});
	...
	public boolean deleteById(int sid) {
		int n = jdbctemplate.update("delete from studentregister101 where sid=?",
