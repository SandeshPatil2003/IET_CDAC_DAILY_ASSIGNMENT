...
public class TestMain {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("5. Sort By Book Price");
			...
			case 3->{
				...
				List<Book> blist = bservice.getAllBooks();
			...
			case 4->{
				...
				boolean status = bservice.updateBookPrice(bid,newprice);
				if(status) {
			...
			case 5->{
				...
				List<Book> blist = bservice.getSorted();
			...
			case 6->{
				...
				boolean status = bservice.deleteBook(bid);
				if(status) {
					System.out.println("Book deleted successfully");
					
				}
				else {
					System.out.println("Book  not found/deleted");
				}
