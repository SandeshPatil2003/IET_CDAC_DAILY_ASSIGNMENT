...
public class StudentDaoImpl implements StudentDao {
	...
	private static double avg(double m1,double m2,double m3)
	{
		return(m1+m2+m3)/3;
	...
	static {
		...
		sset.add(new Student(32,"john",24,25,25,avg(24,25,25)));
		
		sset.add(new Student(55,"tom",53,63,89,avg(53,63,89)));
		sset.add(new Student(36,"jerry",73,29,38,avg(73,29,38)));
		sset.add(new Student(79,"michael",83,23,71,avg(83,23,71)));
		sset.add(new Student(45,"tom",53,63,89,avg(53,63,89)));
		sset.add(new Student(2,"tom",53,63,89,avg(53,63,89)));
		sset.add(new Student(2,"tom",53,63,89,avg(53,63,89)));
